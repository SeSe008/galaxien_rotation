    ...
    view! {
        <div id="equations">
            <Show when=move || { mode.get() == "velocity" }>
                ...
                />
                <TexEquation
                    label="Geschwindigkeit des Halos".to_string()
            ...
            <Show when=move || { mode.get() == "mass" }>
                <TexEquation
                    label="Masse der Scheibe".to_string()
                ...
                <Show
                    ...
                    fallback=|| {
                        view! {
                            <TexEquation
                                label="Masse des Halos bei einer Dichtefunktion nach einer Isothermen Gaskugel"
                                    .to_string()
                ...
                >
                    <TexEquation
                        label="Masse des Halos bei einer Dichtefunktion nach Navarro-Frenk-White"
                            .to_string()
            ...
            <Show when=move || { mode.get() == "density" }>
                <TexEquation
                    label="Dichte der Scheibe".to_string()
                ...
                <Show
                    ...
                    fallback=|| {
                        view! {
                            <TexEquation
                                label="Dichte des Halos bei einer Dichtefunktion nach einer Isothermen Gaskugel"
                                    .to_string()
                ...
                >
                    <TexEquation
                        label="Dichte des Halos bei einer Dichtefunktion nach Navarro, Frenk und White"
                            .to_string()
        ...
        <div id="misc" class="tab_container">
            <div class="tab_selector">
                <button on:click=move |_| {
                    set_tab_selected.set("mass_details");
                }>"Details für Masse bei 30kpc"</button>
                <button on:click=move |_| {
